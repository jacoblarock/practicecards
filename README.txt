...
Helper files/pages will also be copied

In Windows this is analog and can be triggered with the make.bat script.

The data for the questions is stored locally in ".data" files in the same
directory as main.
